...
import { type UrlWithUser } from '@/server/actions/admin/urls/get-all-urls.action';
import { manageFlaggedUrl } from '@/server/actions/admin/urls/manage-flagged-url.action';
                  ...
                  <TableCell className='font-medium'>
                    <div className='flex items-center gap-2'>
                      ...
                      <a
                        ...
                        className='flex max-w-[250px] items-center gap-1 truncate text-blue-600 hover:underline'
                      >
                    ...
                    {url.flagged && url.flagReason && (
                      <div className='mt-1 max-w-[250px] truncate text-xs text-yellow-600 dark:text-yellow-400'>
                          ...
                          <>
                            ...
                            >
                              {actionLoading === url.id && (
                                <Loader2 className='mr-1 size-4' />
                              )}
                              <CheckCircle className='mr-1 size-4 text-green-700' />
                              Approve URL
                            </DropdownMenuItem>
                            <DropdownMenuItem
                            ...
                            >
                              ...
                              <Ban className='mr-1 size-4 text-red-700' />
                              Delete URL
                            </DropdownMenuItem>
                          </>
                        )}
