...
import { type UserWithoutPassword } from '@/server/actions/admin/users/get-all-users.action';
import { updateUserRoleAction } from '@/server/actions/admin/users/update-user-role.action';
...
export function UsersTable({
  ...
  const preserveParams = () => {
    ...
    // Currently no additional parameters to preserve
    // This function is ready for future use if needed
    return '';
  };
